...
button1 = KeyboardButton('обувь мужская ')
button2 = KeyboardButton('обувь женская')
...
button4 = KeyboardButton('каталог одежды ')
button5 = KeyboardButton('духи')
button6 = KeyboardButton('подарки')
